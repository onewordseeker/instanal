    ...
    <div class="az-content az-content-dashboard">
        <div class="container">
                        ...
                        <div class="card card-dashboard-two">
                            <div class="row col-lg-12">
                                <div class="col-lg-4" style="padding: 15px 0px 0px 25px;">
                                    <img src="https://www.comsats.edu.pk/images/Tabassam.jpg" alt=""
                                ...
                                <div class="col-lg-8">
                                    <div class="mg-l-15" style="padding-top: 40px">
                                        <h2 style="margin-bottom: 0px">Irfan Junejo</h2>
                                        <h5 style="color: #9f9f9f">@username</h5>
                                    </div>
                                    <div class="row col-lg-12 mg-t-20">
                                        <div class="col-lg-4">
                                            <h5 style="margin-bottom: 0px">Followers</h5>
                                            <h6 style="color: #9f9f9f">34,43,342</h6>
                                        </div>
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <h6 style="color: #9f9f9f">3,342</h6>
                                ...
                                <div class="card card-dashboard-three">
                                    <div class="card-header">
                                        ...
                                        <h6>16,869 <small class="tx-success"><i class="icon ion-md-arrow-up"></i>
                                                2.87%</small></h6>
                                        <small>The total number of sessions within the date range. It is the
                                            period time a
                                            user is actively engaged with your website, page or app,
                                            etc.</small>
                                    </div><!-- card-header -->
                                    <div class="card-body">
                        ...
                        <div class="card card-dashboard-one">
                            ...
                            <div class="card-body">
                                <div class="card-body-top">
                                    ...
                                    <div>
                                        <label class="mg-b-0">Daily Following</label>
                                        <h2>33.50%</h2>
                                    </div>
                                    <div>
                                        <label class="mg-b-0">Daily Followers</label>
                                        <h2>83,123</h2>
                                    </div>
                ...
                <div class="row row-sm mg-b-20 mg-lg-b-0">
                            ...
                            <div class="col-md-6 col-lg-12 mg-b-20 mg-md-b-0 mg-lg-b-20">
                                <div class="card card-dashboard-five">
                                    <div class="card-header">
                                        ...
                                        <span class="card-text">Average Video Views For The Last 12 Published Video
                                            Posts.</span>
                                    </div><!-- card-header -->
                    ...
                    <div class="col-lg-7 col-xl-8 mg-t-20 mg-lg-t-0">
                        <div class="card card-table-one">
                            <h6 class="card-title">Geolocation of the last 12 posts</h6>
                ...
                <div class="mg-t-20">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mg-b-20">
                            <div class="card card-dashboard-five">
                                <div class="card-header">
                                    <h6 class="card-title">POST FREQUENCY</h6>
                                    <span class="card-text"></span>
                                </div><!-- card-header -->
                                <div class="card-body row row-sm">
                                    <div class="col-6 d-sm-flex align-items-center">
            ...
            <div class="row" style="justify-content: center">
                <div class="card card-dashboard-two" style="padding: 15px; flex-flow: row; align-items: center;">
                    <i class="fa fa-search mr-2" style="color: #a7a3a3"></i>
                    <h4 style="margin-bottom: 0px; color: #a7a3a3">Search by username</h4>
                </div>
            </div>
